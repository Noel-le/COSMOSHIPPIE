...
const createNewPage = () =>{
    ...
    <h1>
        ...
        <img  class = "down_arrow disabled" src="./img/scrollarrowtodown_83796.svg">
        <img  class = "up_arrow" src="./img/upscrollarrow_83865.svg">
        </div>
    </h1>
    <ol>
        <li>
...
<svg style="display: none;">
    ...
    const $cnt = get('.count')
    const $uparrow = get('.up_arrow')
    const $downarrow = get('.down_arrow')
    ...
    $uparrow.onclick = () =>{
        if ($uparrow.classList[0] === 'up_arrow'){
    ...
    $downarrow.onclick = () =>{
        if ($downarrow.classList[0] === 'down_arrow'){
